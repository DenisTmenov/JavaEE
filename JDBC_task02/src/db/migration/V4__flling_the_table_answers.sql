...
INSERT INTO `jdbc_task02_db`.`answers` (`id_a`, `answer`, `trueOrFalse`, `fk_question_id`) VALUES (2, 'Груша', 'false', 1 );
INSERT INTO `jdbc_task02_db`.`answers` (`id_a`, `answer`, `trueOrFalse`, `fk_question_id`)  VALUES (3, 'Динамит', 'false', 1 );
INSERT INTO `jdbc_task02_db`.`answers` (`id_a`, `answer`, `trueOrFalse`, `fk_question_id`)  VALUES (4, 'Ратуша', 'false', 1 );
